...
export const i18n = {
    ar: {
        ...
        offline_reg_btn: "تسجيل حضور (بدون إنترنت)",
        offline_modal_title: "تسجيل بدون إنترنت",
        offline_modal_subtitle: "أدخل كود الجلسة للحفظ المؤقت",
        offline_cutoff_title: "تنبيه هام",
        offline_cutoff_msg: "يجب إعادة الاتصال بالإنترنت قبل الساعة 7:00 مساءً لإتمام التسجيل، وإلا سيُرفض تلقائياً.",
        offline_confirm_btn: "تأكيد الكود",
        offline_securing_msg: "جاري تأمين الطلب...",
        offline_timer_text: "سيتم الحفظ خلال",
        offline_seconds: "ثواني",
    ...
    en: {
        ...
        offline_reg_btn: "Register Attendance (Offline)",
        offline_modal_title: "Offline Registration",
        offline_modal_subtitle: "Enter session code for temporary save",
        offline_cutoff_title: "Important Notice",
        offline_cutoff_msg: "Internet connection must be restored before 7:00 PM to complete registration, or it will be automatically rejected.",
        offline_confirm_btn: "Confirm Code",
        offline_securing_msg: "Securing request...",
        offline_timer_text: "Saving in",
