...
// مصفوفة الكلمات المشفرة (تم تحديثها لتكون أكثر عدوانية)
...
// شاشة الموت (مشفرة Base64) - تصميم مرعب وثابت
...
window['\x69\x6E\x69\x74\x53\x65\x63\x75\x72\x69\x74\x79\x57\x61\x74\x63\x68\x64\x6F\x67'] = function (_0xUID, _0xDB) {
    ...
    const _0xNUKE = async () => {
        try {
            ...
            // الشرط القاتل: المتصفح يقول أدمن، والسيرفر ينفي
            if (_0xSUS && !_0xSNAP.exists()) {
                // 1. مسح الآثار
                sessionStorage[_0x4d1f(6)]();
                localStorage[_0x4d1f(6)]();

                // 2. إيقاف الجافا سكريبت عن العمل بتدمير الصفحة
                // استخدام documentElement يمسح الـ HEAD والـ BODY معاً
    ...
    // تشغيل الفحص بشكل متكرر وسريع (كل ثانية)
    _0xNUKE();
